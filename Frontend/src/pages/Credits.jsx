    ...
    <div className="max-w-7xl h-full overflow-y-auto mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-base sm:text-lg text-gray-600 dark:text-dark-text-secondary max-w-2xl mx-auto">
          Select the perfect plan for your AI needs. All plans include instant access and premium features.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-8 max-w-6xl mx-auto">
        ...
        {plans.map((plan, index) => {
          ...
          const pricePerCredit = calculatePricePerCredit(plan.price, plan.credits);
          
          return (
            <div
              key={plan._id}
              className={`group relative flex flex-col rounded-2xl border-2 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 ${
                isPro
                  ? "bg-gradient-to-br from-[#fffff0] to-[#faf9f6] dark:from-dark-card dark:to-dark-hover border-purple-400 dark:border-icon-active/60 shadow-2xl shadow-purple-500/20 dark:shadow-icon-active/20 md:scale-105"
            ...
            >
              ...
              {isPro && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                  <span className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-icon-active dark:to-icon-active/80 text-white text-xs font-semibold px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
              ...
              <div className="p-6 sm:p-8 flex flex-col flex-1">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {isPro && (
                      <IoDiamond className="w-6 h-6 text-purple-600 dark:text-icon-active" />
                    )}
                  </div>
                ...
                <button
                  ...
                  className={`w-full py-3 sm:py-3.5 px-6 rounded-xl font-semibold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none ${
                    isPro
              ...
              {/* Hover Glow Effect */}
              {isPro && (
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-600/0 via-purple-600/10 to-purple-600/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              )}
            </div>
          );
        })}
      ...
      <div className="mt-12 sm:mt-16 text-center">
        <p className="text-sm sm:text-base text-gray-500 dark:text-dark-text-tertiary">
          All payments are secure and processed through Stripe. Credits never expire.
        </p>
      </div>
    </div>
  );

...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`flex flex-col h-screen w-80 min-w-80 p-6 dark:bg-dark-card bg-[#faf9f6] border-r border-gray-200 dark:border-dark-hover/30 backdrop-blur-3xl transition-all duration-300 ease-in-out fixed md:relative z-50 shadow-2xl md:shadow-none ${
      ...
      >
        ...
        >
          <IoClose className="w-5 h-5 text-gray-600 dark:text-icon-primary" />
        </button>
        ...
        <button
          ...
          className="flex items-center justify-center w-full py-3.5 mb-6 text-black dark:text-dark-text-primary bg-[#fffff0] dark:bg-dark-hover hover:bg-gray-100 dark:hover:bg-dark-hover/80 border border-gray-200 dark:border-dark-hover text-sm font-medium rounded-xl cursor-pointer shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02] group"
        >
        ...
        <div className="relative mb-2 group">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <IoSearch className="w-4 h-4 text-gray-400 dark:text-icon-primary group-focus-within:text-gray-500 dark:group-focus-within:text-icon-active" />
          </div>
          <input
            ...
            className="w-full pl-10 pr-4 py-3 text-sm bg-[#f8fafc] dark:bg-dark-primary border border-gray-200 dark:border-dark-hover rounded-xl placeholder-gray-600 dark:placeholder-gray-400 text-gray-900 dark:text-dark-text-primary outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-icon-active/30 focus:border-transparent transition-all duration-300"
          />
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {chats.length > 0 && (
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm font-semibold text-gray-700 dark:text-dark-text-secondary uppercase tracking-wide">
                Recent Chats
              </p>
              <span className="bg-gray-200 dark:bg-dark-hover text-black dark:text-dark-text-primary text-xs px-2 py-1 rounded-full">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-icon-active/30 scrollbar-track-transparent hover:scrollbar-thumb-icon-active/50 space-y-2 pr-2">
            {filteredChats.map((chat) => (
              <div
                ...
                key={chat._id}
                className="group p-3 bg-[#fffff0] dark:bg-dark-primary border border-gray-200 dark:border-dark-hover/30 rounded-xl cursor-pointer dark:hover:bg-dark-hover hover:border-gray-300 dark:hover:border-dark-hover hover:shadow-md transition-all duration-300 flex items-start justify-between"
              >
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-800 dark:text-dark-text-primary truncate leading-tight">
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 ml-2 p-1.5 bg-gray-800 dark:bg-dark-hover rounded-lg transition-all duration-300 hover:scale-110"
                >
        ...
        <div className="space-y-3 pt-4 border-t border-gray-200/50 dark:border-dark-hover/30">
          ...
          <div
            ...
            className="flex items-center gap-3 p-3 rounded-xl cursor-pointer bg-[#fffff0] dark:bg-dark-primary border border-gray-200 dark:border-dark-hover/30 dark:hover:bg-dark-hover hover:border-gray-300 hover:shadow-md transition-all duration-300 group"
          >
          ...
          {/* Dark Mode Toggle */}
          <div className="flex items-center justify-between p-3 rounded-xl bg-[#fffff0] dark:bg-dark-primary border border-gray-200 dark:border-dark-hover/30 dark:hover:bg-dark-hover hover:border-gray-300 hover:shadow-md transition-all duration-300">
          ...
          {/* User Account */}
          <div className="flex items-center gap-3 p-3 rounded-xl bg-[#fffff0] dark:bg-dark-primary border border-gray-200 dark:border-dark-hover/30 hover:bg-gray-50 dark:hover:bg-dark-hover hover:border-gray-300 hover:shadow-lg transition-all duration-300 group">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-800 dark:text-dark-text-primary truncate">
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 dark:bg-dark-modal/90 z-50 backdrop-blur-sm">
          <div className="bg-white dark:bg-dark-card rounded-2xl p-6 shadow-2xl max-w-sm w-full mx-4 border border-gray-200 dark:border-dark-hover/30">
            ...
            <h2 className="text-lg font-semibold mb-2 text-gray-800 dark:text-dark-text-primary text-center">
              Log Out?
            </h2>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-gray-200 hover:bg-gray-300 dark:bg-dark-hover dark:hover:bg-dark-hover/80 text-gray-800 dark:text-dark-text-primary rounded-lg font-medium transition-all duration-300"
              >
                Cancel
              </button>
              <button
